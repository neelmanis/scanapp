...
class Mdl_admin extends Mdl_generic {
   ...
   *  Admin master
   */
  var $table_admin = 'users';
  var $column_order_admin = array(null,'status','name','username','password_text','role',null); 
  var $column_search_admin = array('name','username','status'); 
  var $order_admin = array("created_at" => "desc"); 

  public function _get_datatables_query_admin(){
