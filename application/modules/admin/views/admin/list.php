    ...
    <div class="card-body">
      <div class="row">
        <div class="col-md-3 col-sm-6 ml-auto">
          <button class="btn btn-block btn-rounded btn-outline-danger" id="delete_records">Delete Records</button>  
        </div>
        <div class="col-md-3 col-sm-6">
          <a class="btn btn-block btn-rounded btn-outline-success" href="<?php echo base_url(); ?>admin/add">Create Admin Account</a>  
        </div>
      </div>
    </div>
