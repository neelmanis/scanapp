...
$(document).ready(function () {
    ...
    //                     }else{
    //                         $("#claimant_name").val(result.data.name).attr("readonly", false);
    //                         $("#claimant_phone").val(result.data.mobile).attr("readonly", false);
    //                         $("#claimant_address").val(result.data.address).attr("readonly", false);
    //                     }
    //                 } else if (result.status == "notExist") {
    //                     $("#claimant_name").attr("readonly", false).focus();
    //                     $("#claimant_phone").attr("readonly", false);
    //                     $("#claimant_address").attr("readonly", false);
    //                 } else {
    //                     swal({
    //                         title: result.title,
    //                         icon: result.icon,
    ...
    $(".remove-caseuser").on("click",function(e){
        e.preventDefault();
          ...
          .then((willDelete) => {
            if (willDelete) {
                ...
                $.ajax({
                    type : 'POST',
                    data : {id:id},
                    url : CI_ROOT + 'common/removeCaseUser',
                    dataType: "json",
                    success:function(result){
