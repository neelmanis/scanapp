...
$(document).ready(function(){
    ...
    //                     }else{
    //                         $("#respondant_name").val(result.data.name).attr("readonly",false);
    //                         $("#respondant_phone").val(result.data.mobile).attr("readonly",false);
    //                         $("#respondant_address").val(result.data.address).attr("readonly",false);
    //                     }
    //                 }else if(result.status == "notExist"){
    //                     $("#respondant_name").attr("readonly",false).focus();
    //                     $("#respondant_phone").attr("readonly",false);
    //                     $("#respondant_address").attr("readonly",false);
    //                 }else{
    //                     swal({
    //                         title: result.title,
    //                         icon: result.icon,
